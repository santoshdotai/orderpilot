...
- [ ] Add Interakt webhook authenticity validation inside [supabase/functions/interakt-webhook/index.ts](/Users/shubham9162/Desktop/Order_Pilot_AI/supabase/functions/interakt-webhook/index.ts)
...
- [ ] Keep all AI and Interakt secrets server-side only in Supabase and n8n
